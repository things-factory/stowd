...
<g id="Layer_1">
	...
	<g>
		<polygon class="st2" points="6.5,7.2 6.5,13 12.5,15.9 12.5,10.4 17,8.1 17,12.9 17.8,13.2 17.8,13.2 17.8,6.9 11.7,9.9 
			11.7,14.7 7.3,12.5 7.3,7.7 13.1,4.6 13.1,4.5 12.3,4.1 		"/>
		<polygon class="st2" points="15.5,5.7 14.6,5.3 8.8,8.5 8.8,10.1 9.6,10.5 9.6,8.9 		"/>
	</g>
</g>
</svg>
`
...
<path class="st0" d="M14.4,1.3c-5.1-0.5-9.6,3-10.1,8c-0.5,5,3.1,8.9,7.8,14c5.6-3.9,10-7,10.6-12C23.1,6.4,19.4,1.9,14.4,1.3z"/>
<path class="st1" d="M12,0.9c-5.1,0-9.2,4-9.2,9c0,5.1,4,8.5,9.2,13.1c5.2-4.5,9.2-8,9.2-13.1C21.2,5,17.1,0.9,12,0.9z"/>
<g>
	<polygon class="st2" points="5.9,7 5.9,13.2 12.4,16.3 12.4,10.4 17.3,8 17.3,13.1 18.1,13.5 18.1,13.5 18.1,6.6 11.6,9.9 11.6,15 
		6.7,12.6 6.7,7.5 13,4.1 13,4.1 12.1,3.7 	"/>
	<polygon class="st2" points="15.6,5.3 14.6,4.9 8.4,8.3 8.4,10.1 9.2,10.5 9.2,8.8 	"/>
</g>
</svg>
`
